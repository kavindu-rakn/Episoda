...
import { ArrowLeft, User, Lock, Check } from 'lucide-react-native';
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.inputContainer}>
          <User size={20} color={COLORS.darkGreen} style={styles.inputIcon} />
          <TextInput
            style={styles.input}
        ...
        {/* Password Field */}
        <View style={styles.inputContainer}>
          <Lock size={20} color={COLORS.darkGreen} style={styles.inputIcon} />
          <TextInput
            style={styles.input}
        ...
        <View style={styles.optionsRow}>
          ...
          >
            <View style={[styles.checkbox, rememberMe && styles.checkboxChecked]}>
              {rememberMe && <Check size={14} color={COLORS.darkGreen} strokeWidth={3} />}
            </View>
